...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-white group/calendar p-4 [--cell-size:2.5rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        nav: cn(
          "absolute inset-x-0 top-0 flex w-full h-10 items-center justify-between gap-1",
        ...
        month_caption: cn(
          "flex h-10 w-full items-center justify-center px-[--cell-size] mb-2",
        ...
        caption_label: cn(
          "select-none font-semibold text-[#1F2D58]",
          captionLayout === "label"
            ? "text-sm"
            : "[&>svg]:text-muted-foreground flex h-9 items-center gap-1.5 rounded-md pl-3 pr-2 text-sm [&>svg]:size-4",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse table-fixed",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-semibold w-[--cell-size] h-[--cell-size] flex items-center justify-center",
        ...
        today: cn(
          "bg-[#193DAB]/10 text-[#1F2D58] rounded-md data-[selected=true]:rounded-none",
