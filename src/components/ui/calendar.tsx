  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none font-medium text-[#1F2D58]",
          captionLayout === "label"
            ? "text-sm"
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-normal w-[--cell-size] h-[--cell-size] flex items-center justify-center",
